...
const signupSchema = z.object({
  ...
  password: z.string()
    ...
    .regex(/^(?=.*[A-Z])(?=.*\d).{8,}$/, 'Requires 1 uppercase and 1 digit'),
});
...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden selection:bg-primary-500 selection:text-white">
      ...
      <div className="absolute top-[-10%] right-[-10%] w-[40%] h-[40%] rounded-full bg-primary-200/40 blur-[120px] pointer-events-none"></div>
      <div className="absolute bottom-[-10%] left-[-10%] w-[40%] h-[40%] rounded-full bg-indigo-200/40 blur-[120px] pointer-events-none"></div>
